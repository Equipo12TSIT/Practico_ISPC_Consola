...
use disqueria;
update album set cod_album= 3535,nombre='todoOnada', id_interprete=2, 
id_genero=1,cant_temas=15,id_discografica=5,id_formato=3,
fec_lanzamiento='2021-09-15',precio=1500,cantidad=3,caratula=null WHERE id_album=11 ; 

use disqueria;
SELECT nombre FROM album WHERE nombre LIKE 'L%';

use disqueria;
select * from genero;

use disqueria;
UPDATE genero SET nombre='Cumbita'  WHERE id_genero= '11';

use disqueria;
select * from interprete;

use disqueria;
UPDATE interprete SET nombre='Ulises',apellido='Bueno',nacionalidad='Argentina',foto=null WHERE id_interprete='2';
